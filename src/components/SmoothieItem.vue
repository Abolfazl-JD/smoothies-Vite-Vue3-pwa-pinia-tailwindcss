...
<template>
    <div class="relative p-5 pt-6 shadow shadow-gray-400">
        <!-- Delete icon -->
        <svg
        @click="smoothiesData.removeSmoothie(smoothie)"
        ...
        <h3 class="text-center text-3xl tracking-wide text-blue-800">{{ smoothie.title }}</h3>
        ...
        xmlns="http://www.w3.org/2000/svg" 
        class="h-12 w-12 p-3 text-white bg-pink-600 font-bold rounded-full absolute right-5 -bottom-5 cursor-pointer" 
        viewBox="0 0 20 20" 
        fill="currentColor">
